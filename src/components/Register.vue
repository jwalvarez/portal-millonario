...
<template>
  <div class="flex w-full h-auto px-48 py-6">
    <div class="my-auto w-9/12">
      <h1 class="text-5xl text-success font-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h1>
      <div class="flex my-8">
